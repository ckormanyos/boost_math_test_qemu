...
#if(BOOST_MATH_TEST_QEMU_TYPE == BOOST_MATH_TEST_QEMU_TYPE_CBRT_TGAMMA)
...
auto boost::math::test::qemu::run_boost_math_cbrt_tgamma() -> bool
{
...
extern "C"
{
  ...
  auto app_benchmark_run_standalone(void) -> bool
  {
    ...
    {
      result_is_ok &= boost::math::test::qemu::run_boost_math_cbrt_tgamma();
    }
